                ...
                <div class="col-6">
                    ...
                    <div class="product-image">
                        <div class="product-image-main">
                            <img src="img/fruits/orange-img1.png" alt="Veggie Wrap" id="product-main-image">
                        </div>
                        <div class="product-image-slider">
                            <img src="img/fruits/orange-img1.png" alt=""  class="image-list">
                            <img src="img/fruits/orange-img2.png" alt=""  class="image-list">
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <div class="product">
                        ...
                        <div class="product-details">
                            <h3>Description</h3>
                            <p>Savor the bright and zesty delight of oranges. Bursting with refreshing citrus flavor, oranges offer a juicy and tangy experience that awakens the taste buds. Whether enjoyed as a snack, juiced for a refreshing beverage.</p>
                        </div>
